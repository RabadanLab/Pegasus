...
public class LocIterator implements Iterator<Location>
{
	...
	*/	
    ...
    public static void main( String args[] )
    {
       ...
       Log.log( "10 to 21, 1 by 1" );
       for( Location t: r.window( 1, 1 )) { Log.log( t.toString() ); }
       
       Log.log( "10 to 21, 3 by 3" );
       for( Location t: r.window( 3, 3 )) { Log.log( t.toString() ); }
       
       Log.log( "10 to 21, 3 by 1" );
       for( Location t: r.window( 3, 1 )) { Log.log( t.toString() ); }
     
       Log.log( "10 to 21, 11 by 1" );
       for( Location t: r.window( 11, 1 )) { Log.log( t.toString() ); }
       
       Log.log( "10 to 21, 12 by 1" );
       for( Location t: r.window( 12, 1 )) { Log.log( t.toString() ); }
       ...
       Log.log( "JavaGene.LocIterator Passed." );
